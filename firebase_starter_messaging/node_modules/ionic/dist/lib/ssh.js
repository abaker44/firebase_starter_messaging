...
exports.ERROR_SSH_ANNOTATION_MISSING = 'SSH_ANNOTATION_MISSING';
exports.ERROR_SSH_ANNOTATION_INVALID_WHITESPACE = 'SSH_ANNOTATION_INVALID_WHITESPACE';
...
function parsePublicKeyFile(pubkeyPath) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            yield cli_utils_1.fsStat(pubkeyPath);
        }
        catch (e) {
            if (e.code === 'ENOENT') {
                throw cli_utils_1.ERROR_FILE_NOT_FOUND;
            }
            throw e;
        }
        return parsePublicKey((yield cli_utils_1.fsReadFile(pubkeyPath, { encoding: 'utf8' })).trim());
    });
}
...
function parsePublicKey(pubkey) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (!r[3]) {
            throw exports.ERROR_SSH_ANNOTATION_MISSING;
        }
        r[1] = r[1].trim();
        r[2] = r[2].trim();
        r[3] = r[3].trim();
        if (r[3].match(/\s/)) {
            throw exports.ERROR_SSH_ANNOTATION_INVALID_WHITESPACE;
        }
...
function validatePrivateKey(keyPath) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            yield cli_utils_1.fsStat(keyPath);
        }
        catch (e) {
            if (e.code === 'ENOENT') {
        ...
        const f = yield cli_utils_1.fsReadFile(keyPath, { encoding: 'utf8' });
        const lines = f.split('\n');
