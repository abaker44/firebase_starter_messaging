...
function getTranspiledDecoratorExpressionStatements(sourceFile) {
    ...
    expressionStatements.forEach(function (expressionStatement) {
        if (expressionStatement && expressionStatement.expression
            ...
            expressionStatement.expression.right.arguments.forEach(function (argument) {
                if (argument.kind === typescript_1.SyntaxKind.ArrayLiteralExpression) {
                    var injectableFound = false;
                    for (var _i = 0, _a = argument.elements; _i < _a.length; _i++) {
                        var element = _a[_i];
                        if (element.kind === typescript_1.SyntaxKind.CallExpression && element.expression
                            && element.expression.text === 'Injectable') {
...
function getDecoratorsExpressionStatements(typescriptFile) {
    ...
    for (var _i = 0, expressionStatements_2 = expressionStatements; _i < expressionStatements_2.length; _i++) {
        ...
        if (expressionStatement.expression && expressionStatement.expression.left && expressionStatement.expression.left.name && expressionStatement.expression.left.name.text === 'decorators') {
